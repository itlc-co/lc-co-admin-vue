      ...
      <el-col :span="20" :xs="24">
        ...
        >
          ...
          <el-form-item label="状态" prop="status">
            ...
            >
              <el-option
                v-for="dict in dict.type.common_normal_disable"
                :key="dict.value"
                :label="dict.label"
                :value="dict.value"
              />
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="部门" align="center" key="deptName" prop="deptName" v-if="columns[3].visible"
                           :show-overflow-tooltip="true"
          />
          <el-table-column label="角色" align="center" key="roleNames" v-if="columns[4].visible" width="200"
          >
            <template slot-scope="scope">
              <el-tag type="info" size="small" v-for="(roleName,index) in scope.row.roleNames"
          ...
          <el-table-column label="手机号码" align="center" key="phoneNumber" prop="phoneNumber" v-if="columns[5].visible"
                           width="120"
          />
...
export default {
  name: 'User',
  dicts: ['common_normal_disable', 'user_sex'],
  ...
  created() {
    this.getList()
    this.getDeptTree()
    this.getConfigKey('initPassword').then(response => {
      const config = response.data
      this.initPassword = config.configValue
    })
  },
  methods: {
    /** 查询用户列表 */
