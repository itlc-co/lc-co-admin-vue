<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="访问地址" prop="accessLocation">
        <el-input
          v-model="queryParams.accessLocation"
          placeholder="请输入访问地址"
          clearable
          style="width: 240px;"
    ...
    <el-table ref="tables" v-loading="loading" :data="list" @selection-change="handleSelectionChange" :default-sort="defaultSort" @sort-change="handleSortChange">
      ...
      <el-table-column label="访问地址" align="center" prop="accessLocation" :show-overflow-tooltip="true" />
...
export default {
  ...
  methods: {
    ...
    /** 清空按钮操作 */
    handleClean() {
      this.$modal.confirm('是否确认清空所有访问日志数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('monitor/accessRecord/export', {
        ...this.queryParams
