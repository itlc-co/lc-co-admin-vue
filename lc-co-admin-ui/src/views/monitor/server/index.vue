          ...
          <div class="el-table el-table--enable-row-hover el-table--medium">
            <table cellspacing="0" style="width: 100%;">
              ...
              <tr>
                ...
                <td class="el-table__cell is-leaf">
                  <div class="cell" v-if="server.cpu">{{ server.cpu.user }}%</div>
                </td>
              </tr>
              <tr>
                <td class="el-table__cell is-leaf">
          ...
          <div class="el-table el-table--enable-row-hover el-table--medium">
            <table cellspacing="0" style="width: 100%;">
              ...
              <tr>
                ...
                <td class="el-table__cell is-leaf">
                  <div class="cell" v-if="server.os">{{ server.os.osName }}</div>
                </td>
              </tr>
              <tr>
                <td class="el-table__cell is-leaf">
                ...
                <td class="el-table__cell is-leaf">
                  <div class="cell" v-if="server.os">{{ server.os.osArch }}</div>
                </td>
              </tr>
              </tbody>
            </table>
          ...
          <div class="el-table el-table--enable-row-hover el-table--medium">
            <table cellspacing="0" style="width: 100%;table-layout:fixed;">
              ...
              <tr>
                ...
                <td class="el-table__cell is-leaf">
                  <div class="cell" v-if="server.jvm">{{ parseTime(server.jvm.startTime) }}</div>
                </td>
                <td class="el-table__cell is-leaf">
              ...
              <tr>
                ...
                <td colspan="3" class="el-table__cell is-leaf">
                  <div class="cell" v-if="server.system">{{ server.system.workDir }}</div>
                </td>
              </tr>
              <tr>
                <td colspan="1" class="el-table__cell is-leaf">
        ...
        <el-card>
          ...
          <div class="el-table el-table--enable-row-hover el-table--medium">
            <table cellspacing="0" style="width: 100%;">
              ...
              <tbody v-if="server.systemFiles">
              <tr v-for="(systemFile, index) in server.systemFiles" :key="index">
                <td class="el-table__cell is-leaf">
                  <div class="cell">{{ systemFile.dirName }}</div>
                </td>
                <td class="el-table__cell is-leaf">
                  <div class="cell">{{ systemFile.dirTypeName }}</div>
                </td>
                <td class="el-table__cell is-leaf">
                  <div class="cell">{{ systemFile.typeName }}</div>
                </td>
                <td class="el-table__cell is-leaf">
                  <div class="cell">{{ systemFile.total }}</div>
                </td>
                <td class="el-table__cell is-leaf">
                  <div class="cell">{{ systemFile.free }}</div>
                </td>
                <td class="el-table__cell is-leaf">
                  <div class="cell">{{ systemFile.used }}</div>
                </td>
                <td class="el-table__cell is-leaf">
                  <div class="cell" :class="{'text-danger': systemFile.usage > 80}">{{ systemFile.usage }}%</div>
                </td>
              </tr>
              </tbody>
            </table>
